...
for y in range(height):
	count = count + 1
	for x in range(width):
		new.save("dir2/"+outputfile+str (count)+".png")
		...
		image = Image.open("dir2/"+outputfile+str (count)+".png")
		
		new_image = image.resize((500, 500))
		new_image.save("dir2/"+outputfile+str (count)+".png")
		new_image.save("dir2/"+outputfile+str ((width*2)-count)+".png")
